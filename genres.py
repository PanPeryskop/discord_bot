...
class Genres:
    def __init__(self, sp):
        self.genres = ['pop', 'rap', 'rock', 'urbano latino', 'hip hop', 'trap latino', 'reggaeton', 'dance pop', 'pop rap',
    ...
    def get_song(self):
        ...
        results = self.sp.search(q=f'genre:"{random_genre}"', type='track', limit=50)
